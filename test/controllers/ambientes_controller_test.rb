...
class AmbientesControllerTest < ActionController::TestCase
  ...
  test "should create ambiente" do
    assert_difference('Ambiente.count') do
      post :create, ambiente: { ambiente: @ambiente.ambiente, sistema_domotico_id: @ambiente.sistema_domotico_id }
    end
  ...
  test "should update ambiente" do
    patch :update, id: @ambiente, ambiente: { ambiente: @ambiente.ambiente, sistema_domotico_id: @ambiente.sistema_domotico_id }
    assert_redirected_to ambiente_path(assigns(:ambiente))
  end
